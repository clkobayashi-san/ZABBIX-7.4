# 📘 Guia Completo de Instalação e Configuração do Zabbix 7.4 no Debian 13

Este guia detalha passo a passo a instala  o do **Zabbix Server 7.4** no **
debian 13 LTS**, utilizando **MariaDB 11.8.6**, **Apache2**, **PHP 8.4.21** e incluindo o Frontend e Agent2 do Zabbix.
